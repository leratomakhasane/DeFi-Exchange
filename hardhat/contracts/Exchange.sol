...
contract Exchange is ERC20 {
    ...
    //inheriting ERC20, to keep track of Crypto Dev LP tokens
    ...
    function addLiquidity(uint _amount) public payable returns (uint) {
        ...
        if(cryptoDevTokenReserve == 0) {
            ...
            require(_amount >= cryptoDevTokenAmount, "Amountof tokens sent is less than the minimum tokens required");
